...
def test_arrow_points():
    ...
    assert res == ((47, 52), (52, 47), (97, 93), (100, 100), (93, 97))

    res = func(*end, *beg, 6)[0]
    assert res == ((102, 97), (97, 102), (52, 56), (50, 50), (56, 52))

    beg, end = (100, 100), (100, 50)
    res = func(*beg, *end, 6)[0]
    assert res == ((97, 100), (103, 100), (103, 56), (100, 50), (97, 56))

    res = func(*end, *beg, 6)[0]
    assert res == ((97, 50), (103, 50), (103, 94), (100, 100), (97, 94))

    beg, end = (100, 100), (50, 100)
    res = func(*beg, *end, 6)[0]
    assert res == ((100, 97), (100, 103), (56, 103), (50, 100), (56, 97))

    res = func(*end, *beg, 6)[0]
    assert res == ((50, 103), (50, 97), (94, 97), (100, 100), (94, 103))


def test_one_arrow_str():
    Arrow = lib.arrowlib.Arrow
    assert Arrow.one_from_str("Arrow((10, 10), (20, 20), (20, 20, 20))") == Arrow(
        (10, 10), (20, 20), (20, 20, 20)
    )
    assert Arrow.one_from_str("Arrow((10, 10), (20, 20), (20, 20, 20, 20))") == Arrow(
